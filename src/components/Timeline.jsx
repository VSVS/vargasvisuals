            ...
            <Grid.Row>
             ...
             <Grid.Row>
              ...
              <div className='string-wrapper'>
                ...
                <p>This was my first job after graduation and the beginning of my 
                    professional career. During my time at <a href="http://duggal.com/" target="_blank">Duggal</a> I learned advanced
             ...
             <Grid.Row>
              ...
              <Grid.Column mobile="13" computer="13">
                ...
                <p>As I still needed more experience in web development to completly transition mediums I accepted an offer from another printing company while I prepared to join a developer bootcamp in the coming months. During this stage in my career at <a href="https://www.vgsonline.com/" target="_blank">VGS</a> I trained some of the machine operators on how to push creative production to its limit. I demonstrated how to engrave with lasers by installing new software and providing prepped photoshop files and how to use routing machines to build props.</p>
              </Grid.Column>
            </Grid.Row>
           ...
           <Grid.Row>
              ...
              <Grid.Column mobile="13" computer="13">
                <div>
                    ...
                    <p>I started 2014 strong by deep diving into coding by joining a 3 month long part time bootcamp led by <a href="https://twitter.com/itsdeshazer" target="_blank">Mike De’shazer</a>, a software enginner and seriel entrepreneur. At the time this was <a href="https://en.wikipedia.org/wiki/LAMP_(software_bundle)" target="_blank">lamp stack</a> focused and I became more logical about my designs.</p>
                </div>
                <div>
            ...
            <Grid.Row>
              ...
              <Grid.Column mobile="13" computer="13">
                ...
                <p>I participated in the <a href="https://www.meetup.com/NY-JavaScript/events/236589552/" target="_blank">Code In the Dark</a> front end competition in which I placed 2nd. The rules were simply to build a web page based off a screenshot of a random website without using any libraries  and without previewing your code. After 15 minutes the crowd would vote for the winner of that round until the final round.</p>
              </Grid.Column>
            </Grid.Row>
